...
### MILESTONE 2 PLAN AND READINESS: OVERALL
...
###MILESTONE 2 CURRENT WORK
- DATABASE FOR LOG IN PAGE -JUAN
- MATCH JUAN CLASSES TO OURS AND MATCH LOG IN PAGE CLASSES (IF NEEDED) - MIKE
- GRAPH IMPLEMENTATION - MARLYN (DONE)
- PUT EVERYTHING ON GITHUB MAIN BRANCH AND MAKE WEBSITE
...
- REPORT ( MIKE)
- AI BOT (MARLYN)
- FINAL TOUCHES /DEBUG. MAKES SURE EVERYTHING RUNS SMOOTHLY(JUAN)
